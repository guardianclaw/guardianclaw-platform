...
safety validation subsystems in GuardianClaw. It defines:
...
Architecture:
    ...
    ├── MobileRobotValidator (safety/mobile/)
    └── SimulationValidator (safety/simulation/)

Usage:
    from guardianclaw.safety.base import SafetyLevel, SafetyResult, SafetyValidator
...
logger = logging.getLogger("guardianclaw.safety.base")
...
class ViolationType(Enum):
    ...
    kinds of safety issues. They map to specific CLAW gates and
    ...
    Categories:
        ...
        - CLAW gates: Credibility, Limits, Avoidance, Worth violations
    ...
    TRUTH_VIOLATION = "credibility"
    HARM_VIOLATION = "avoidance"
    SCOPE_VIOLATION = "limits"
    PURPOSE_VIOLATION = "worth"
    ...
    def gate(self) -> Optional[str]:
        """Get the CLAW gate this violation corresponds to, if any."""
        gate_mapping = {
            ViolationType.TRUTH_VIOLATION: "credibility",
            ViolationType.INVALID_VALUE: "credibility",
            ViolationType.INVALID_TYPE: "credibility",
            ViolationType.MISSING_REQUIRED: "credibility",
            ViolationType.HARM_VIOLATION: "avoidance",
            ViolationType.FORCE: "avoidance",
            ViolationType.TORQUE: "avoidance",
            ViolationType.CONTACT_FORCE: "avoidance",
            ViolationType.COLLISION: "avoidance",
            ViolationType.SCOPE_VIOLATION: "limits",
            ViolationType.JOINT_POSITION: "limits",
            ViolationType.JOINT_VELOCITY: "limits",
            ViolationType.JOINT_ACCELERATION: "limits",
            ViolationType.WORKSPACE: "limits",
            ViolationType.ZONE: "limits",
            ViolationType.VELOCITY_LIMIT: "limits",
            ViolationType.ALTITUDE_LIMIT: "limits",
            ViolationType.ACTION_SPACE: "limits",
            ViolationType.PURPOSE_VIOLATION: "worth",
            ViolationType.BALANCE: "avoidance",
            ViolationType.FALL_RISK: "avoidance",
        }
...
class SafetyResult:
    ...
    Attributes:
        ...
        gates: Results of individual CLAW gates (credibility, avoidance, limits, worth).
    ...
    def validate(
        ...
        Args:
            ...
            context: Optional contextual information for validation:
                    ...
                    - worth: Stated worth of the action
