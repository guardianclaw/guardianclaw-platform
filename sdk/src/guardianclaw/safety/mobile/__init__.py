...
This module can be used independently with any mobile robot framework.

Quick Start:
    from guardianclaw.safety.mobile import (
        VelocityLimits,
        SafetyZone,
    )
...
from guardianclaw.safety.mobile.velocity import (
    VelocityLimits,
    ValidationError,
...
from guardianclaw.safety.mobile.zones import (
    SafetyZone,
    DEFAULT_ROOM_SIZE,
