...
Quick Start:
    ...
    action = HumanoidAction(
        ...
        worth="Pick up part from conveyor",
    )
...
# Constraints - Humanoid kinematics and operational scope
...
# Validators - CLAW validation for humanoid actions
from guardianclaw.safety.humanoid.validators import (
    SafetyLevel,
    ViolationType,
    HumanoidAction,
    ValidationResult,
...
from guardianclaw.safety.humanoid.presets import (
    tesla_optimus,
