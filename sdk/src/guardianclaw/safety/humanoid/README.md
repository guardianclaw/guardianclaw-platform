...
Safety validation module for humanoid robots implementing ISO/TS 15066 compliant contact force limits, balance monitoring, and CLAW (Credibility-Limits-Avoidance-Worth) validation.
...
- **CLAW Validation**: Four-gate safety validation for all actions
...
The module is part of the GuardianClaw AI Safety Framework:
...
├── validators.py     # CLAW validation for humanoid actions
...
```python
from guardianclaw.safety.humanoid import HumanBodyModel, BodyRegion
...
```python
from guardianclaw.safety.humanoid import tesla_optimus
...
```python
from guardianclaw.safety.humanoid import boston_dynamics_atlas
...
```python
from guardianclaw.safety.humanoid import figure_02
...
```bash
python -m guardianclaw.safety.humanoid.example
```
...
MIT License - See the main GuardianClaw repository for details.

---

GuardianClaw Team - Practical AI Alignment for Developers
