"""Example usage of GuardianClaw integration with Google ADK.

This module demonstrates various ways to integrate GuardianClaw's CLAW
...
async def example_plugin_based():
    """Use GuardianClawPlugin for global guardrails on a Runner.
    ...
    # Create GuardianClaw plugin with default settings
    ...
    print("Running with GuardianClawPlugin...")
...
async def example_all_callbacks():
    """Use create_claw_callbacks for quick setup.
...
async def main():
    """Run all examples."""
    print("=" * 60)
    print("Google ADK + GuardianClaw Integration Examples")
    print("=" * 60)
