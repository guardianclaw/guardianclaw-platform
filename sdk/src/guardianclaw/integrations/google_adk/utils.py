"""Utility functions for Google ADK GuardianClaw integration.
...
class GuardianClawLogger:
    """Simple logger protocol for GuardianClaw integration."""
...
class DefaultLogger(GuardianClawLogger):
    """Default logger using Python's logging module."""

    def __init__(self, name: str = "claw.google_adk"):
