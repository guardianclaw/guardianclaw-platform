"""
Example: Using GuardianClaw with Anthropic SDK.

Shows how to add safety to Claude API calls.

Requirements:
    pip install anthropic guardianclaw
"""
...
def example_safe_client():
    """Example 1: Using GuardianClawAnthropic client."""
    ...
    # Create GuardianClaw-protected client with heuristic validation
    ...
    if isinstance(message, dict) and message.get("claw_blocked"):
...
def example_wrap_existing():
    ...
    print("Existing client wrapped with GuardianClaw protection")
    print("Use: safe_client.messages.create(...)")


if __name__ == "__main__":
    print("=" * 60)
    print("GuardianClaw + Anthropic SDK Integration Examples")
    print("=" * 60)
