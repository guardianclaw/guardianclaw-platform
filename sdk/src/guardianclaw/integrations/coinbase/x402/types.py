"""Type definitions for GuardianClaw x402 integration.

This module defines all types used in the x402 payment validation layer,
following the x402 protocol specification and GuardianClaw CLAW framework.
...
# Import CLAWGate from validators (canonical source)
...
class CLAWGateResult:
    """Result of a single CLAW gate evaluation."""
...
class PaymentValidationResult:
    ...
    Attributes:
        ...
        gates: Results from each CLAW gate
    ...
    def all_gates_passed(self) -> bool:
        """Check if all CLAW gates passed."""
