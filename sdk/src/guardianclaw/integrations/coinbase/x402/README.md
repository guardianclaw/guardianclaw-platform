# GuardianClaw x402 Payment Validation

CLAW safety validation for [x402](https://github.com/coinbase/x402) payment protocol.

x402 is an HTTP-native payment protocol by Coinbase that enables AI agents to make autonomous payments. This integration adds GuardianClaw's CLAW safety gates to ensure payments are validated before execution.
...
GuardianClaw validates x402 payments using four gates:
...
```python
from guardianclaw.integrations.coinbase.x402 import get_default_config
...
### claw_x402_get_spending_summary
