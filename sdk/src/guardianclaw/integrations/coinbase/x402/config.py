"""Configuration and constants for GuardianClaw x402 integration.
...
@dataclass
class GuardianClawX402Config:
    """Complete configuration for GuardianClaw x402 middleware.
...
def get_default_config(
    ...
    Returns:
        GuardianClawX402Config with appropriate settings.
    ...
    if profile == "permissive":
        ...
        return GuardianClawX402Config()  # Default values
    elif profile == "strict":
        return GuardianClawX402Config(
            spending_limits=SpendingLimits(
