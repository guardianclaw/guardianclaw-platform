"""Pydantic schemas for GuardianClaw x402 AgentKit actions.

These schemas define the input parameters for each GuardianClaw x402 action,
...
class SafeX402RequestSchema(BaseModel):
    """Schema for making a safe x402 HTTP request with GuardianClaw validation."""
