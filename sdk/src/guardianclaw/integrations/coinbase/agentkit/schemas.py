"""
Pydantic Schemas for GuardianClaw AgentKit Actions.

These schemas provide input validation for all GuardianClaw
...
class ValidateTransactionSchema(BaseModel):
    ...
    worth: Optional[str] = Field(
        None,
        description="Stated worth/reason for the transaction",
    )
...
class CheckActionSafetySchema(BaseModel):
    ...
    worth: Optional[str] = Field(
        None,
        description="Stated worth for the action",
    )
...
class ConfigureGuardrailsSchema(BaseModel):
    ...
    require_purpose: Optional[bool] = Field(
        None,
        description="Whether to require worth for high-risk actions",
    )
