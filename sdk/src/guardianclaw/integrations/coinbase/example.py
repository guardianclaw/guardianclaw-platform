"""
Example usage of GuardianClaw Coinbase Integration.

This module demonstrates how to use GuardianClaw's comprehensive
    ...
    transactions = [
        {
            ...
            "worth": "Payment for API services",
        },
        {
            "action": "native_transfer",
            "from_address": "0x742d35Cc6634C0532925a3b844Bc454e4438f44e",
...
def example_x402_integration() -> None:
    ...
    from guardianclaw.integrations.coinbase.x402 import PaymentRequirementsModel
...
def main() -> None:
    """Run all examples."""
    print("=" * 60)
    print("GuardianClaw Coinbase Integration Examples")
    print("=" * 60)
