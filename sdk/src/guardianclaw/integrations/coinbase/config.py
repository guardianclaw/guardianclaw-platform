...
Centralized configuration for GuardianClaw's Coinbase ecosystem integration,
...
@dataclass
class GuardianClawCoinbaseConfig:
    """
    Main configuration for GuardianClaw's Coinbase integration.

    This is the central configuration object that controls all
    security behavior for AgentKit and x402 integrations.

    Example:
        from guardianclaw.integrations.coinbase import GuardianClawCoinbaseConfig

        # Use default standard profile
        config = GuardianClawCoinbaseConfig()
    ...
    def block_address(self, address: str) -> "GuardianClawCoinbaseConfig":
        """
    ...
    def unblock_address(self, address: str) -> "GuardianClawCoinbaseConfig":
    ...
    def block_action(self, action: str) -> "GuardianClawCoinbaseConfig":
    ...
    def allow_action(self, action: str) -> "GuardianClawCoinbaseConfig":
        """
    ...
    def use_profile(self, profile: Union[str, SecurityProfile]) -> "GuardianClawCoinbaseConfig":
        """
...
def get_default_config(profile: str = "standard") -> GuardianClawCoinbaseConfig:
    """
    ...
    Returns:
        GuardianClawCoinbaseConfig with appropriate settings
    ...
    return GuardianClawCoinbaseConfig(security_profile=profile_enum)
