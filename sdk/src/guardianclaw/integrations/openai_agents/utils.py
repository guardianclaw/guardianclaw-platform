    ...
    def __init__(
        ...
        if not self._logger.handlers:
            ...
            handler.setFormatter(
                logging.Formatter('[GUARDIANCLAW] %(levelname)s: %(message)s')
            )
...
_logger: Optional[GuardianClawLogger] = None
...
def set_logger(logger: GuardianClawLogger) -> None:
    ...
    Args:
        logger: Logger implementing the GuardianClawLogger protocol

    Example:
        import logging

        custom_logger = logging.getLogger("my_app.claw")
