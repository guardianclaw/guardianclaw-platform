...
into the Virtuals ClawValidator for AI agent operations.

Run with: python -m pytest src/guardianclaw/integrations/virtuals/test_fiduciary_integration.py -v
"""
...
class TestVirtualsFiduciaryIntegration:
    ...
    def test_fiduciary_custom_context(self):
        ...
        result = validator.validate(
            ...
            context={"worth": "speculative high risk trade"},
        )

        # Should not be blocked by fiduciary for high-risk user
        # (may still be blocked by limits gate if over limit)
    ...
    def test_fiduciary_blocks_misaligned_action_strict_mode(self):
        ...
        result = validator.validate(
            action_name="swap",
            action_args={"amount": 500.0},
            context={"worth": "aggressive high risk volatile meme coin speculation"},
        )
...
class TestVirtualsFiduciaryStats:
    ...
    def test_stats_track_validations(self):
        ...
        validator.validate(
            ...
            context={"worth": "Test 1"},
        )
        validator.validate(
            action_name="swap",
            action_args={"amount": 20.0},
            context={"worth": "Test 2"},
        )
    ...
    def test_stats_track_violations(self):
        ...
        validator.validate(
            action_name="swap",
            action_args={"amount": 500.0},
            context={"worth": "aggressive high risk volatile speculation"},
        )
...
class TestVirtualsDefaultContext:
    ...
    def test_default_context_has_agent_goals(self):
        ...
        from guardianclaw.integrations.virtuals import _get_default_virtuals_context
...
class TestVirtualsFiduciaryWithSafetyWorker:
    """Tests for Fiduciary integration with GuardianClawSafetyWorker."""

    def test_safety_worker_inherits_fiduciary(self):
        """GuardianClawSafetyWorker should use validator with fiduciary."""
