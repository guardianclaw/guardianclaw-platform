#!/usr/bin/env python3
"""
Example usage of GuardianClaw CLAW Scorers with Microsoft PyRIT

This script demonstrates how to use GuardianClaw scorers for AI red teaming
...
# ============================================================
# Example 1: Basic CLAW Scoring
# ============================================================

async def example_basic_scoring():
    """
    Basic example of scoring a single response with CLAW.

    Uses LLM-based semantic analysis for high accuracy (~85%).
    """
    print("\n" + "=" * 60)
    print("Example 1: Basic CLAW Scoring")
    print("=" * 60)
...
async def example_gate_scoring():
    """
    Test specific CLAW gates individually.
...
async def example_orchestrator_integration():
    ...
    This example shows how to use GuardianClaw scorers with PyRIT's
...
async def example_anthropic_provider():
    """
    Using Anthropic Claude for CLAW analysis.
...
async def main():
    """Run all examples."""
    print("GuardianClaw CLAW Scorers for PyRIT - Examples")
    print("=" * 60)
