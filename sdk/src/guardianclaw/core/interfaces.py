"""
GuardianClaw Core Interfaces - Protocol definitions for validators.
...
if TYPE_CHECKING:
    from guardianclaw.validation.types import ValidationResult


@runtime_checkable
class Validator(Protocol):
    """
    Protocol defining the contract for all GuardianClaw validators.
    ...
    - CLAWValidator: Heuristic-only validation with 700+ patterns
    ...
    def validate_action(
        ...
        Args:
            ...
            worth: Stated worth or reason for the action.
                    Used for CLAW Worth Gate validation.
        ...
        Example:
            result = validator.validate_action(
                ...
                worth="Clean up temporary cache files",
            )
            if result.is_safe:
