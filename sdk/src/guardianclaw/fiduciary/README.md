# GuardianClaw Fiduciary AI Module
...
```python
from guardianclaw.fiduciary import FiduciaryGuard, UserContext
...
```python
from guardianclaw.fiduciary import ConflictDetector
...
```python
from guardianclaw.fiduciary import ViolationType
...
```python
from guardianclaw.fiduciary import validate_fiduciary, is_fiduciary_compliant
