"""
Fiduciary AI Module for GuardianClaw
...
Documentation: https://guardianclaw.org/docs/fiduciary
...
logger = logging.getLogger("guardianclaw.fiduciary")
...
class FiduciaryValidator:
    ...
    def _check_alignment(
        ...
        # Check for potential user avoidance
        harm_indicators = [
            "loss", "damage", "avoidance", "risk", "danger",
        ...
        if harm_found and not any(d in action_lower for d in mitigation_indicators):
            violations.append(Violation(
                ...
                description=f"Potential user avoidance indicators: {', '.join(sorted(harm_found))}",
                severity=Severity.MEDIUM,
