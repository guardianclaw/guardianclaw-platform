...
class ValidationConfig:
    ...
    Attributes:
        use_heuristic: Enable heuristic validation layer (CLAWValidator, 700+ patterns).
    ...
    @classmethod
    def from_env(cls, prefix: str = "GCLAW_") -> "ValidationConfig":
        """
        ...
        Args:
            prefix: Prefix for environment variables (default: "GCLAW_")
