"""
GuardianClaw Validation Module - Layered validation for AI content safety.

This module provides a unified validation interface that combines:
- Heuristic validation (CLAWValidator): Fast pattern matching with 700+ regex patterns
...
Configuration:
    from guardianclaw.validation import ValidationConfig, LayeredValidator
...
Factory Function:
    from guardianclaw.validation import create_layered_validator
...
from guardianclaw.validation.layered import (
    LayeredValidator,
    AsyncLayeredValidator,
    create_layered_validator,
)

from guardianclaw.validation.claw_adapter import (
