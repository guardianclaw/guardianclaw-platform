...
Run with:
    python -m guardianclaw.compliance.example
...
def example_9_csa_all_domains():
    ...
    Check content against all CLAW-supported AICM domains.
    """
    print("\n" + "=" * 60)
...
def main():
    ...
    print("\nFor production use:")
    print("  pip install guardianclaw[openai]  # For semantic validation")
    print("  export OPENAI_API_KEY=your-key")
    print("\nDocumentation:")
    print("  https://guardianclaw.org/docs/compliance/eu-ai-act")
    print("  https://guardianclaw.org/docs/compliance/csa-aicm")
