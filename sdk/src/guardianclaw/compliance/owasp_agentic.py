"""
OWASP Top 10 for Agentic Applications (2026) Compliance Checker using GuardianClaw CLAW.
...
- Credibility Gate: ASI08, ASI09
- Avoidance Gate: ASI09
- Limits Gate: ASI01, ASI02
- Worth Gate: ASI01, ASI10
...
logger = logging.getLogger("guardianclaw.compliance.owasp_agentic")
...
class CoverageLevel(str, Enum):
    """GuardianClaw coverage level for OWASP Agentic vulnerabilities."""
    FULL = "full"
    PARTIAL = "partial"
...
# Vulnerability to CLAW Gate and GuardianClaw component mapping
VULNERABILITY_COVERAGE: Dict[AgenticVulnerability, Dict[str, Any]] = {
    ...
    AgenticVulnerability.ASI09_HUMAN_AGENT_TRUST: {
        ...
        "coverage": CoverageLevel.FULL,
        "component": "CLAW Credibility + Avoidance Gates, Fiduciary AI Module",
    ...
    AgenticVulnerability.ASI10_ROGUE_AGENTS: {
        ...
        "coverage": CoverageLevel.FULL,
        "component": "CLAW Protocol + Anti-Self-Preservation",
...
class AgenticFinding:
    ...
    Attributes:
        ...
        protected: Whether GuardianClaw provides protection
        coverage_level: GuardianClaw coverage level for this vulnerability
        component: GuardianClaw component providing protection
        gates_relevant: Which CLAW gates are relevant
...
class OWASPAgenticChecker:
    """
    Assess GuardianClaw's coverage of OWASP Top 10 for Agentic Applications.

    This checker evaluates which vulnerabilities GuardianClaw protects against
    ...
    def get_coverage_assessment(
        ...
        if include_metadata:
            metadata = {
                ...
                "claw_components_used": self._get_components_used(findings),
            }
    ...
    def _get_partial_recommendation(self, vuln: AgenticVulnerability) -> str:
        ...
        recommendations = {
            AgenticVulnerability.ASI03_IDENTITY_PRIVILEGE_ABUSE:
                ...
                "and token limits enforcement. Database Guard provides query validation.",
            AgenticVulnerability.ASI04_SUPPLY_CHAIN:
            ...
            AgenticVulnerability.ASI08_CASCADING_FAILURES:
                ...
                "and workflow isolation. Credibility Gate validates factual accuracy.",
        }
        return recommendations.get(
            vuln,
    ...
    def _get_components_used(self, findings: List[AgenticFinding]) -> List[str]:
        """Get list of GuardianClaw components providing protection."""
        components = set()
