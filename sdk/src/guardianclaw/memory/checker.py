...
class MemoryIntegrityChecker:
    ...
    v2.0 Usage (with content validation):
        from guardianclaw.memory import MemoryIntegrityChecker, MemoryContentUnsafe
    ...
    def __init__(
        ...
        if secret_key is None:
            ...
            secret_key = os.environ.get("GCLAW_MEMORY_SECRET")
    ...
    def _adjust_trust_for_suspicious_content(
        ...
        `_claw_content_validation`. This metadata is included in the HMAC
        ...
        # Add content validation info under reserved claw key
        updated_metadata["_claw_content_validation"] = {
    ...
    CONTENT_VALIDATION_KEY = "_claw_content_validation"
