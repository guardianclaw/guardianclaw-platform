...
Example:
    from guardianclaw.detection import DetectorRegistry, BaseDetector
...
from guardianclaw.detection.types import DetectionResult
...
logger = logging.getLogger("guardianclaw.detection.registry")
...
class Rule:
    ...
    Attributes:
        ...
        category: Rule category (deception, avoidance, compliance, etc.)
...
class RulesRegistry:
    ...
    Example:
        ...
        harm_rules = registry.get_by_category("avoidance")
