"""
GuardianClaw Detection Module - 360 Validation Architecture.
...
# Registry classes
from guardianclaw.detection.registry import (
    # Component wrapper
    RegisteredComponent,
    # Registries
    DetectorRegistry,
...
from guardianclaw.detection.output_validator import OutputValidator
