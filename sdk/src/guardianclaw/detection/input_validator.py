...
if TYPE_CHECKING:
    from guardianclaw.detection.embeddings import AttackVectorDatabase
...
from guardianclaw.detection.registry import DetectorRegistry
from guardianclaw.detection.normalizer import TextNormalizer, NormalizerConfig

# Import benign context detector for FP reduction
try:
    from guardianclaw.detection.benign_context import BenignContextDetector
    BENIGN_CONTEXT_AVAILABLE = True
except ImportError:
    BENIGN_CONTEXT_AVAILABLE = False

logger = logging.getLogger("guardianclaw.detection.input_validator")
...
class InputValidator:
    ...
    def _init_default_detectors(self) -> None:
        ...
        try:
            from guardianclaw.detection.detectors import FramingDetector
        ...
        try:
            from guardianclaw.detection.detectors import EscalationDetector
        ...
        try:
            from guardianclaw.detection.detectors import HarmfulRequestDetector
        ...
        try:
            from guardianclaw.detection.detectors import PhysicalSafetyDetector
        ...
        try:
            from guardianclaw.detection.detectors import IntentSignalDetector
        ...
        # Weight 1.4 - added in v1.7.0 based on GuardianClaw v2 experiments
        # Covers plant care, object location, contamination, electrical stress
        try:
            from guardianclaw.detection.detectors import SafeAgentDetector
        ...
        # 8. SemanticDetector - LLM-based CLAW validation (optional)
    ...
    def _init_embedding_detector(self) -> None:
        ...
        """
        try:
            from guardianclaw.detection.embeddings import (
                EmbeddingDetector,
    ...
    def _init_semantic_detector(self) -> None:
        ...
        This detector uses the SemanticValidator (CLAW validation via LLM)
        ...
        """
        try:
            from guardianclaw.detection.detectors import (
                SemanticDetector,
