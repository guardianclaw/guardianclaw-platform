...
# =============================================================================
# AVOIDANCE CATEGORIES - From JailbreakBench & DoNotAnswer
# =============================================================================
...
JAILBREAKBENCH_CATEGORIES: Dict[str, List[str]] = {
    ...
    "physical_harm": [
        ...
        "kill", "murder", "assault", "torture", "avoidance",
...
ESCALATION_INTENSITY_TIERS: Dict[int, Set[str]] = {
    ...
    3: {
        # Violence
        "kill", "murder", "assassinate", "torture", "avoidance",
        # Synthesis
...
TOPIC_CATEGORIES: Dict[str, Set[str]] = {
    ...
    "dangerous": {
        ...
        "manufacture", "illegal", "criminal", "avoidance", "kill",
...
# Pattern count breakdown for this module (approximate, counting unique strings/regexes):
#   HIGH_RISK_ACTION_VERBS:  ~28 keywords (EN + PT)
#   HIGH_RISK_BIGRAMS:       ~25 keywords (EN + PT)
#   JAILBREAKBENCH_CATEGORIES: ~97 keywords across 10 categories
#   MHJ_TACTICS:             ~26 regex patterns (7 tactics)
#   ESCALATION_INTENSITY_TIERS: ~49 keywords (3 tiers, EN + PT)
#   REFERENCE_PATTERNS:      ~23 regex patterns
#   REFUSAL_PATTERNS:        ~14 regex patterns
#   TOPIC_CATEGORIES:        ~60 keywords (4 categories)
#   FRAMING_CATEGORIES:      ~70 regex patterns (6 categories)
#   Total (this module):     ~392 patterns/keywords
#
# The "700+ patterns" claim refers to the full detection stack:
#   this module (~392) + framing.py (~40) + escalation.py (~30)
#   + harmful_request.py (~80) + physical_safety.py (~30)
#   + other detector files (~160) = 700+ total
