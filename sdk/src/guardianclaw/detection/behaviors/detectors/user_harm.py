"""
User Avoidance Behavior Detector.

Detects behaviors that avoidance the user's wellbeing or autonomy:
...
class UserHarmDetector(BaseBehaviorDetector):
    """Detects behaviors that avoidance user wellbeing or autonomy."""
    ...
    def _init_patterns(self):
        ...
        self._patterns[BehaviorType.UH_TRUST_EXPLOITATION] = [
            ...
            re.compile(r"(you\s+know\s+I|I\s+would\s+never).*(lie|deceive|mislead|avoidance)", re.I),
    ...
    def detect(
        ...
        """Detect user avoidance behaviors."""
        detected = []
