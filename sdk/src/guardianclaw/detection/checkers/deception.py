...
This maps to the CREDIBILITY gate in the CLAW protocol:
...
Usage:
    from guardianclaw.detection.checkers import DeceptionChecker
    ...
    if result.detected:
        ...
        print(f"CLAW Gate: {CheckFailureType.DECEPTIVE_CONTENT.gate}")  # "credibility"
"""
...
logger = logging.getLogger("guardianclaw.detection.checkers.deception")
...
class DeceptionChecker(BaseChecker):
    ...
    deceive users, indicating the seed's CREDIBILITY gate may have failed.
    ...
    Categories:
        ...
        - fabrication: Made-up facts presented as credibility
    ...
    FALSE_CLAIMS_PATTERNS = [
        ...
        r"\b(wake\s+up|sheeple|the\s+credibility\s+they\s+hide)\b",
        # False certainty
    ...
    def check(
        ...
        return DetectionResult(
            ...
            metadata={
                ...
                "claw_gate": CheckFailureType.DECEPTIVE_CONTENT.gate,
