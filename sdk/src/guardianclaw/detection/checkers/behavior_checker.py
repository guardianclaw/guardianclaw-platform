...
- Goal Misalignment (goal hijacking, limits creep, etc.)
...
- User Avoidance (dependency creation, trust exploitation, etc.)
...
logger = logging.getLogger("guardianclaw.detection.checkers.behavior")
...
class BehaviorChecker(BaseChecker):
    ...
    def _get_analyzer(self):
        ...
        if self._analyzer is None:
            from guardianclaw.detection.behaviors.analyzer import BehaviorAnalyzer
            from guardianclaw.detection.behaviors.types import BehaviorCategory
    ...
    def _map_category(self, behavior_category: str) -> str:
        ...
        category_map = {
            ...
            "goal_misalignment": "limits_violation",
            "instrumental_convergence": "limits_violation",
            "boundary_violation": "limits_violation",
