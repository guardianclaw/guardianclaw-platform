...
This maps to the LIMITS gate in the CLAW protocol:
...
Usage:
    from guardianclaw.detection.checkers import ComplianceChecker
    from guardianclaw.detection.registry import RulesRegistry, Rule
...
logger = logging.getLogger("guardianclaw.detection.checkers.compliance")
...
class ComplianceChecker(BaseChecker):
    ...
    Rule Categories:
        ...
        - avoidance: Rules about harmful content
    ...
    def check(
        ...
        return DetectionResult(
            ...
            metadata={
                ...
                "claw_gate": CheckFailureType.POLICY_VIOLATION.gate,
            },
        )
