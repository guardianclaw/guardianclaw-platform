...
This maps to the AVOIDANCE gate in the CLAW protocol:
...
Usage:
    ...
    if result.detected:
        ...
        print(f"CLAW Gate: {CheckFailureType.HARMFUL_CONTENT.gate}")  # "avoidance"
"""
...
logger = logging.getLogger("guardianclaw.detection.checkers.harmful")
...
class HarmfulContentChecker(BaseChecker):
    ...
    cause harm, indicating the seed's AVOIDANCE gate may have failed.
    ...
    # Expanded to cover all major avoidance categories
    HARMFUL_OUTPUT_PATTERNS = {
        ...
        "fiction_bypass": [
            ...
            r"(character|protagonist)\s+(explains|describes|shows)\s+how\s+to\s+.{0,30}(crime|illegal|avoidance|kill|steal)",
    ...
    def check(
        ...
        return DetectionResult(
            ...
            metadata={
                ...
                "claw_gate": CheckFailureType.HARMFUL_CONTENT.gate,
            },
        )
