...
Usage:
    from guardianclaw.detection.checkers import BypassIndicatorChecker
...
logger = logging.getLogger("guardianclaw.detection.checkers.bypass")
    ...
    def check(
        ...
        return DetectionResult(
            ...
            metadata={
                ...
                "claw_gate": CheckFailureType.BYPASS_INDICATOR.gate,
