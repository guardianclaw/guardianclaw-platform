"""
Tests for guardianclaw.detection.checkers.compliance module.
...
class TestComplianceCheckerMetadata:
    ...
    def test_claw_gate_in_metadata(self):
        """CLAW gate is included in metadata."""
        registry = RulesRegistry()
        registry.add(Rule(
            id="test",
            description="Test",
        ...
        assert result.detected is True
        assert result.metadata.get("claw_gate") == "limits"
