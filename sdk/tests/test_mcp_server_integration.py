...
class TestVersion:
    ...
    def test_version_exists(self):
        ...
        from guardianclaw.integrations.mcp_server import __version__
...
class TestTextTooLargeError:
    ...
    def test_creation(self):
        """Test error creation."""
        from guardianclaw.integrations.mcp_server import TextTooLargeError
...
class TestValidateTextSize:
    ...
    def test_valid_text_passes(self):
        ...
        from guardianclaw.integrations.mcp_server import _validate_text_size
...
class TestMCPClientError:
    ...
    def test_creation(self):
        """Test error creation."""
        from guardianclaw.integrations.mcp_server import MCPClientError
...
class TestMCPTimeoutError:
    ...
    def test_creation(self):
        ...
        from guardianclaw.integrations.mcp_server import MCPTimeoutError
...
class TestMCPConnectionError:
    ...
    def test_creation(self):
        """Test error creation."""
        from guardianclaw.integrations.mcp_server import MCPConnectionError
...
class TestMCPAvailability:
    ...
    def test_mcp_available_is_bool(self):
        ...
        from guardianclaw.integrations.mcp_server import MCP_AVAILABLE
...
class TestGuardianClawMCPClientInit:
    """Tests for GuardianClawMCPClient initialization."""

    def test_url_only(self):
        """Test initialization with URL only."""
        from guardianclaw.integrations.mcp_server import GuardianClawMCPClient

        client = GuardianClawMCPClient(url="http://localhost:8000/mcp")
    ...
    def test_command_only(self):
        ...
        client = GuardianClawMCPClient(
            command="python",
            args=["-m", "guardianclaw.integrations.mcp_server"],
        )
        assert client.command == "python"
        assert client.args == ["-m", "guardianclaw.integrations.mcp_server"]
    ...
    def test_both_raises_error(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            GuardianClawMCPClient(url="http://localhost", command="python")
    ...
    def test_default_timeout(self):
        ...
        client = GuardianClawMCPClient(url="http://localhost:8000")
    ...
    def test_custom_timeout(self):
        ...
        client = GuardianClawMCPClient(url="http://localhost:8000", timeout=60.0)
...
class TestGuardianClawMCPClientMethods:
    """Tests for GuardianClawMCPClient methods with mocks."""
...
class TestCallWithTimeout:
    ...
    def test_uses_default_timeout(self):
        ...
        client = GuardianClawMCPClient(url="http://localhost:8000", timeout=1.0)
...
class TestServerCreation:
    ...
    def test_create_server_requires_mcp(self):
        """Test create_claw_mcp_server requires MCP package."""
        from guardianclaw.integrations.mcp_server import (
            MCP_AVAILABLE,
    ...
    def test_add_tools_requires_mcp(self):
        """Test add_claw_tools requires MCP package."""
        from guardianclaw.integrations.mcp_server import (
            MCP_AVAILABLE,
            add_claw_tools,
        )
...
class TestExports:
    ...
    def test_all_main_exports(self):
        ...
        assert isinstance(MCP_AVAILABLE, bool)
        assert create_claw_mcp_server
        assert add_claw_tools
        assert GuardianClawMCPClient
        assert run_server
...
class TestExampleImports:
    ...
    def test_example_importable(self):
        ...
        try:
            from guardianclaw.integrations.mcp_server import example
            assert example
        except ImportError:
    ...
    def test_main_function_exists(self):
        ...
        try:
            from guardianclaw.integrations.mcp_server.example import main
...
class TestIntegrationWithMCP:
    ...
    def test_create_server_success(self, skip_if_no_mcp):
        ...
        mcp = create_claw_mcp_server(name="test-server")
        assert mcp is not None

    def test_create_server_custom_claw(self, skip_if_no_mcp):
        """Test server creation with custom GuardianClaw instance."""
        from guardianclaw.integrations.mcp_server import create_claw_mcp_server
        from guardianclaw import GuardianClaw

        claw = GuardianClaw(seed_level="minimal")
        mcp = create_claw_mcp_server(claw=claw)
        assert mcp is not None
...
class TestEdgeCases:
    ...
    def test_timeout_zero_handling(self):
        ...
        client = GuardianClawMCPClient(url="http://localhost:8000", timeout=0.001)
    ...
    def test_empty_args_list(self):
        ...
        client = GuardianClawMCPClient(command="python", args=[])
        assert client.args == []
    ...
    def test_args_none_becomes_empty_list(self):
        ...
        client = GuardianClawMCPClient(command="python", args=None)
        assert client.args == []
