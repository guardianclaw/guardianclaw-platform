"""
Tests for guardianclaw.detection.output_validator module.
...
Test Categories:
    ...
    4. CLAW Gate Mapping: Failure types map to correct gates
...
from guardianclaw.detection import (
    OutputValidator,
...
# =============================================================================
# CLAW Gate Mapping Tests
# =============================================================================

class TestOutputValidatorGateMapping:
    """Tests for CLAW gate mapping."""

    def test_harmful_content_maps_to_avoidance_gate(self):
        """HARMFUL_CONTENT maps to avoidance gate."""
        assert CheckFailureType.HARMFUL_CONTENT.gate == "avoidance"

    def test_deceptive_content_maps_to_credibility_gate(self):
        """DECEPTIVE_CONTENT maps to credibility gate."""
        assert CheckFailureType.DECEPTIVE_CONTENT.gate == "credibility"

    def test_limits_violation_maps_to_limits_gate(self):
        """SCOPE_VIOLATION maps to limits gate."""
        assert CheckFailureType.SCOPE_VIOLATION.gate == "limits"

    def test_worth_violation_maps_to_worth_gate(self):
