...
class TestCLAWGate:
    ...
    def test_is_string_enum(self):
        """CLAWGate should be a string enum."""
        assert isinstance(CLAWGate.CREDIBILITY, str)
        assert CLAWGate.CREDIBILITY == "credibility"
...
# =============================================================================
# Tests for CLAWResult
# =============================================================================

class TestCLAWResult:
    """Test CLAWResult dataclass."""
    ...
    def test_create_unsafe_result(self):
        ...
        result = CLAWResult(
            ...
            reasoning="Content enables avoidance",
            risk_level=RiskLevel.HIGH,
        )
        assert result.is_safe is False
        assert result.harm_passes is False
        assert result.violated_gate == "avoidance"
    ...
    def test_to_dict(self):
        ...
        assert d["violated_gate"] == "avoidance"
...
class TestSemanticValidatorValidate:
    ...
    @patch("guardianclaw.validators.semantic.SemanticValidator._call_openai")
    ...
    @patch("guardianclaw.validators.semantic.SemanticValidator._call_anthropic")
...
class TestValidateActionAndRequest:
    ...
    def test_validate_action_with_purpose(self, mock_call):
        ...
        result = validator.validate_action(
            "send_email",
            worth="Notify user of completed task",
        )

        call_args = mock_call.call_args[0][0]
        assert "Worth:" in call_args
...
class TestAsyncSemanticValidator:
    ...
    @pytest.mark.asyncio
    @patch("guardianclaw.validators.semantic.AsyncSemanticValidator._call_openai_async")
    ...
    @pytest.mark.asyncio
    @patch("guardianclaw.validators.semantic.AsyncSemanticValidator._call_anthropic_async")
    ...
    async def test_async_parse_json_code_block(self, mock_call):
        ...
        mock_call.return_value = {
            "content": """```json
{"is_safe": false, "harm_passes": false, "violated_gate": "avoidance", "reasoning": "Bad", "risk_level": "high"}
```"""
        }
...
# =============================================================================
# Tests for CLAW_VALIDATION_PROMPT
# =============================================================================
...
class TestValidationPrompt:
    ...
    def test_prompt_has_content_placeholder(self):
        ...
        assert "{content}" in CLAW_VALIDATION_PROMPT

    def test_prompt_requests_json(self):
        """Verify prompt requests JSON response."""
        assert "JSON" in CLAW_VALIDATION_PROMPT
        assert "is_safe" in CLAW_VALIDATION_PROMPT
...
class TestFullPipeline:
    ...
    def test_full_unsafe_validation_flow(self, mock_call):
        ...
        assert "worth" in result.failed_gates

    # Helper method for CLAWResult
...
# Add helper method to CLAWResult for testing
...
CLAWResult.all_gates_pass = _all_gates_pass
