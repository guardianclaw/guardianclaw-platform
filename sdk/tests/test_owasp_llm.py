"""Tests for guardianclaw.compliance.owasp_llm module (OWASP LLM Top 10)."""
...
from guardianclaw.compliance.owasp_llm import Severity
...
class TestVulnerabilityGateMapping:
    ...
    def test_strong_coverage_vulnerabilities(self):
        """Test vulnerabilities with strong CLAW coverage."""
        strong_vulns = [
    ...
    def test_not_applicable_vulnerabilities(self):
        """Test vulnerabilities not applicable to CLAW."""
        na_vulns = [
    ...
    def test_prompt_injection_uses_limits_gate(self):
        """Test LLM01 Prompt Injection uses Limits gate."""
        mapping = VULNERABILITY_GATE_MAPPING[OWASPVulnerability.LLM01_PROMPT_INJECTION]
        assert "limits" in mapping["gates"]

    def test_misinformation_uses_credibility_gate(self):
        """Test LLM09 Misinformation uses Credibility gate."""
