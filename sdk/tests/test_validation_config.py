"""
Tests for guardianclaw.validation.config module.
"""

import os
import pytest
from guardianclaw.validation.config import (
    ValidationConfig,
    DEFAULT_CONFIG,
    STRICT_CONFIG,
)
...
class TestValidationConfigFromEnv:
    ...
    def test_from_env_uses_defaults(self):
        ...
        for key in ["GCLAW_USE_SEMANTIC", "GCLAW_FAIL_CLOSED"]:
    ...
    def test_from_env_reads_bool_values(self):
        ...
        os.environ["GCLAW_USE_SEMANTIC"] = "true"
        os.environ["GCLAW_FAIL_CLOSED"] = "1"
