"""
Tests for ClawIntegration and AsyncClawIntegration base classes.
...
all integrations can safely inherit from them.
"""
...
from guardianclaw.core.interfaces import Validator
...
class MockValidator:
    ...
    def validate_input(self, text: str) -> ValidationResult:
        ...
        from guardianclaw.validation.types import ValidationMode
...
class MyIntegration(ClawIntegration):
...
class MyAsyncIntegration(AsyncClawIntegration):
...
class TestClawIntegration:
    ...
    def test_custom_validator_injection(self):
        ...
        integration = ClawIntegration(validator=mock_validator)
    ...
    def test_validation_config_creates_configured_validator(self):
        ...
        integration = ClawIntegration(validation_config=config)
...
class TestClawIntegrationWithRealValidator:
...
# ============================================================================
# AsyncClawIntegration Tests
# ============================================================================

class TestAsyncClawIntegration:
    """Tests for the AsyncClawIntegration class."""

    def test_default_creates_async_layered_validator(self):
        """Default init creates AsyncLayeredValidator."""
        integration = AsyncClawIntegration()
    ...
    def test_custom_validator_injection(self):
        ...
        integration = AsyncClawIntegration(validator=mock_validator)
...
# ============================================================================
# Validation 360° Tests - ClawIntegration
# ============================================================================

class TestClawIntegration360:
    """Tests for Validation 360° methods in ClawIntegration."""
...
class TestClawIntegration360WithRealValidator:
...
# ============================================================================
# Validation 360° Tests - AsyncClawIntegration
# ============================================================================
...
class TestAsyncClawIntegration360:
    """Tests for Validation 360° methods in AsyncClawIntegration."""
    ...
    async def test_with_mock_async_validator(self):
        ...
        integration = AsyncClawIntegration(validator=mock)
