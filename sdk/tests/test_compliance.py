"""Tests for guardianclaw.compliance module (EU AI Act)."""
...
class TestRiskAssessment:
    ...
    def test_create_assessment(self):
        ...
        assessment = RiskAssessment(
            ...
            gates_evaluated={"credibility": True, "avoidance": False}
        )
    ...
    def test_to_dict(self):
        ...
        result = ComplianceResult(
            ...
            article_9_risk_assessment=RiskAssessment(
                ...
                risk_score=0.5,
                mitigation_recommended=True,
                gates_evaluated={"credibility": True}
            ),
            article_14_oversight_required=True,
        ...
        assert d["article_9_risk_assessment"]["gates_evaluated"] == {"credibility": True}
...
class TestFailClosedMode:
    ...
    def test_fail_closed_false_default(self):
        ...
        checker = EUAIActComplianceChecker()
        # Without API key and without CLAWValidator, should be safe by default
