"""Tests for guardianclaw.compliance.csa_aicm module (CSA AI Controls Matrix)."""
...
from guardianclaw.compliance.csa_aicm import Severity
...
class TestDomainGateMapping:
    ...
    def test_model_security_has_all_gates(self):
        """Test Model Security domain has all 4 CLAW gates."""
        mapping = DOMAIN_GATE_MAPPING[AICMDomain.MODEL_SECURITY]
        assert "credibility" in mapping["gates"]
        assert "avoidance" in mapping["gates"]
...
class TestThreatGateMapping:
    ...
    def test_not_applicable_threats(self):
        """Test threats not applicable to CLAW."""
        na_threats = [
...
class TestDomainFinding:
    ...
    def test_create_compliant_finding(self):
        ...
        finding = DomainFinding(
            ...
            gates_checked=["credibility", "avoidance", "limits", "worth"],
            gates_passed=["credibility", "avoidance", "limits", "worth"],
            gates_failed=[],
        )
    ...
    def test_create_non_compliant_finding(self):
        ...
        finding = DomainFinding(
            ...
            gates_checked=["credibility", "avoidance"],
            gates_passed=["credibility"],
    ...
    def test_to_dict(self):
        ...
        assert d["gates_checked"] == ["credibility"]
