"""
Tests for guardianclaw.detection.checkers.base module.
...
class TestBaseCheckerIntegration:
    ...
    def test_claw_gate_mapping(self):
        """Checker failure types map to correct CLAW gates."""
        # Test that checkers can produce failures mapped to all CLAW gates
        from guardianclaw.detection.types import CheckFailureType

        # Verify CLAW mapping is available through CheckFailureType
