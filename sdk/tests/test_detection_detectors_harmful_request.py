"""
Tests for guardianclaw.detection.detectors.harmful_request module.
...
Test Categories:
    ...
    4. Physical Avoidance: Violence, weapons, poison
    5. Economic Avoidance: Fraud, theft, extortion
...
# =============================================================================
# Test Physical Avoidance Detection
# =============================================================================
...
# =============================================================================
# Test Economic Avoidance Detection
# =============================================================================

class TestEconomicHarmDetection:
    """Tests for economic avoidance request detection."""
    ...
    def test_detects_economic_harm_requests(self, detector, attack):
        """Test detection of economic avoidance requests."""
        result = detector.detect(attack)
