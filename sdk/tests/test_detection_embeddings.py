"""
Tests for guardianclaw.detection.embeddings module.
...
from guardianclaw.detection.types import AttackType
...
class TestGetAvailableProvider:
    ...
    def test_returns_null_when_none_available(self):
        ...
        with patch.dict('os.environ', {}, clear=True):
            with patch(
                'guardianclaw.detection.embeddings.OpenAIEmbeddings.is_available',
                return_value=False
            ):
                with patch(
                    'guardianclaw.detection.embeddings.OllamaEmbeddings.is_available',
                    return_value=False
                ):
...
class TestProductionDatabase:
    ...
    def production_database(self):
        ...
        prod_path = Path(__file__).parent.parent / (
            "src/guardianclaw/detection/embeddings/data/attack_vectors.json"
        )
