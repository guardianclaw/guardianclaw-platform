...
Tests cover:
- Types (PaymentRiskLevel, PaymentDecision, CLAWGate, etc.)
- Config (SpendingLimits, ValidationConfig, get_default_config)
- Validators (CLAW gates: Credibility, Limits, Avoidance, Worth)
...
# Import middleware
from guardianclaw.integrations.coinbase.x402.middleware import (
...
# Import schemas
from guardianclaw.integrations.coinbase.x402.schemas import (
...
class TestCLAWGate:
    """Tests for CLAWGate enum."""

    def test_values(self):
        """All CLAW gates should be defined."""
        assert CLAWGate.CREDIBILITY.value == "credibility"
        assert CLAWGate.AVOIDANCE.value == "avoidance"
        assert CLAWGate.LIMITS.value == "limits"
        assert CLAWGate.WORTH.value == "worth"
...
class TestCLAWGateResult:
    """Tests for CLAWGateResult dataclass."""

    def test_create_passed(self):
        """Should create passed result."""
        result = CLAWGateResult(gate=CLAWGate.CREDIBILITY, passed=True)
...
class TestPaymentValidationResult:
    ...
    def test_all_gates_passed_one_failed(self):
        ...
        result = PaymentValidationResult(
            ...
            gates={
                CLAWGate.CREDIBILITY: CLAWGateResult(gate=CLAWGate.CREDIBILITY, passed=True),
                CLAWGate.AVOIDANCE: CLAWGateResult(gate=CLAWGate.AVOIDANCE, passed=False, reason="Blocked"),
            },
        )
...
class TestGuardianClawX402Config:
    """Tests for GuardianClawX402Config dataclass."""
...
class TestCLAWPaymentValidator:
    """Tests for CLAWPaymentValidator orchestrator."""
    ...
    def test_validate_all_pass(self):
        ...
        assert CLAWGate.CREDIBILITY in results
        assert CLAWGate.AVOIDANCE in results
        assert CLAWGate.LIMITS in results
        assert CLAWGate.WORTH in results
        assert all(r.passed for r in results.values())

    def test_calculate_risk_blocked(self):
        """Should return BLOCKED for AVOIDANCE failure."""
        validator = CLAWPaymentValidator()
        config = get_default_config("standard")
        req = create_test_payment_req()
        ...
        gate_results = {
            CLAWGate.CREDIBILITY: CLAWGateResult(gate=CLAWGate.CREDIBILITY, passed=True),
            CLAWGate.AVOIDANCE: CLAWGateResult(gate=CLAWGate.AVOIDANCE, passed=False),
            CLAWGate.LIMITS: CLAWGateResult(gate=CLAWGate.LIMITS, passed=True),
    ...
    def test_calculate_risk_critical(self):
        ...
        gate_results = {
            CLAWGate.CREDIBILITY: CLAWGateResult(gate=CLAWGate.CREDIBILITY, passed=False),
            CLAWGate.AVOIDANCE: CLAWGateResult(gate=CLAWGate.AVOIDANCE, passed=True),
            CLAWGate.LIMITS: CLAWGateResult(gate=CLAWGate.LIMITS, passed=False),
            CLAWGate.WORTH: CLAWGateResult(gate=CLAWGate.WORTH, passed=True),
        }
...
class TestGuardianClawX402Middleware:
    """Tests for GuardianClawX402Middleware."""
    ...
    def test_init_custom_config(self):
        ...
        config = get_default_config("strict")
        middleware = GuardianClawX402Middleware(config=config)
...
class TestCreateGuardianClawX402Middleware:
    """Tests for factory function."""

    def test_create_with_profile(self):
        """Should create middleware with profile."""
        middleware = create_claw_x402_middleware("strict")
        assert middleware.config.spending_limits.max_single_payment == 25.0
