...
import dev.guardianclaw.jetbrains.compliance.CompliancePatterns
import dev.guardianclaw.jetbrains.services.*
import dev.guardianclaw.jetbrains.util.SecurityPatterns
...
class ActionsTest {
    ...
    inner class PromptInjectionFormattingTests {
        ...
        fun formatWithGates() {
            ...
            assertThat(message).contains("limits")
        }
    }
