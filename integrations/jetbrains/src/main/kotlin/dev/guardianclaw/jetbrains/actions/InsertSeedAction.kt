...
import dev.guardianclaw.jetbrains.util.Seeds

/**
 * Action to insert the standard GuardianClaw alignment seed
 */
class InsertSeedAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        Messages.showInfoMessage(
            project,
            "GuardianClaw standard seed inserted (~$tokenCount tokens)",
            "GuardianClaw"
        )
    }
