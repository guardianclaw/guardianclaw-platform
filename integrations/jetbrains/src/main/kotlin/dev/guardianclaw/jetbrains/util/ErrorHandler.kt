...
/**
 * Centralized error handling for the GuardianClaw plugin.
 *
...
object ErrorHandler {
    ...
    private const val NOTIFICATION_GROUP = "GuardianClaw AI Safety"
    ...
    private fun logError(error: GuardianClawError) {
    ...
    private fun showNotification(error: GuardianClawError, project: Project) {
