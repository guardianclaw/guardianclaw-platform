...
/**
 * Structured logging utility for the GuardianClaw plugin.
 *
 * Provides:
 ...
 * - Log level filtering
 */
object GuardianClawLogger {

    private val logger = Logger.getInstance("GuardianClaw")
    ...
    class ComponentLogger(@PublishedApi internal val component: String) {
        ...
        inline fun <T> timed(
            ...
            return GuardianClawLogger.timed(message, component, action, context, block)
        }
    }
}
