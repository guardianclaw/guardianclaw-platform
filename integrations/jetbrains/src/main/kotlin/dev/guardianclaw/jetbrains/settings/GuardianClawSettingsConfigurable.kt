...
/**
 * Settings panel for GuardianClaw AI Safety plugin.
 * Accessible via Settings → Tools → GuardianClaw AI Safety
 */
class GuardianClawSettingsConfigurable : Configurable {
    ...
    private val useGuardianClawApiCheckbox = JBCheckBox("Use GuardianClaw API")
    ...
    override fun createComponent(): JComponent {
        panel = panel {
            ...
            group("Behavior") {
                ...
                row {
                    cell(showStatusBarCheckbox)
                        .comment("Show GuardianClaw status in the status bar")
                }
            }

            group("GuardianClaw API (Optional)") {
                row {
                    cell(useGuardianClawApiCheckbox)
                        .comment("Use GuardianClaw's hosted API instead of direct LLM calls")
                }
                row("API Endpoint:") {
            ...
            row {
                browserLink("Documentation", "https://guardianclaw.dev/docs")
                browserLink("GitHub", "https://github.com/claw-seed/claw")
            }
        }
    ...
    override fun isModified(): Boolean {
        ...
        return llmProviderCombo.selectedItem != settings.llmProvider ||
                ...
                useGuardianClawApiCheckbox.isSelected != settings.useGuardianClawApi ||
                apiEndpointField.text != settings.clawApiEndpoint
    }
    ...
    override fun apply() {
        ...
        settings.useGuardianClawApi = useGuardianClawApiCheckbox.isSelected
        settings.clawApiEndpoint = apiEndpointField.text
    }
