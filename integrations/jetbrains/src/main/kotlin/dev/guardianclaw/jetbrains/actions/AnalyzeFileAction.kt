...
class AnalyzeFileAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        if (content.isBlank()) {
            GuardianClawToolWindowFactory.showMessage(project, "File is empty", isError = true)
            return
        }

        ProgressManager.getInstance().run(object : Task.Backgroundable(project, "Analyzing file with GuardianClaw...", true) {
