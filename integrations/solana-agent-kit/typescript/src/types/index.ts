/**
 * Type definitions for GuardianClaw Solana Agent Kit Plugin
 *
...
/**
 * CLAW Gate identifiers - the four gates of the GuardianClaw protocol
 * Credibility: Is the action based on accurate information?
 * Avoidance: Could this cause damage to users or systems?
 * Limits: Is this within appropriate boundaries?
 * Worth: Does this serve a legitimate benefit?
 */
...
/**
 * Result of a single CLAW gate check
 */
...
/**
 * Configuration options for the GuardianClaw plugin
 */
export interface GuardianClawPluginConfig {
  ...
  /**
   * Actions that require explicit worth justification
...
> & Pick<GuardianClawPluginConfig, "customPatterns" | "blockedAddresses" | "allowedPrograms"> = {
 ...
 *
 * Includes CLAW jailbreak detection patterns to protect against prompt injection
