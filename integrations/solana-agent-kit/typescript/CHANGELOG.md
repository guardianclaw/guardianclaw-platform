...
- Validated against `solana-agent-kit@2.0.10` and `@solana/web3.js@1.98.4`.
  Public type imports (`Plugin`, `Action`, `SolanaAgentKit`) unchanged; no
  source or peer-range adjustments needed. devDep bumped to `^2.0.10`.

### Validation

- 71/71 tests pass, typecheck clean, build clean.
...
### Added
- Initial release of @guardianclaw/solana-agent-kit
- CLAW Protocol validation (Credibility, Limits, Avoidance, Worth)
...
### Security
- CLAW four-gate validation protocol
