"""
Unit tests for GuardianClaw Promptfoo Provider

Tests all functions and validates bug fixes from audit #052.
"""

import pytest
from guardianclaw_promptfoo.provider import (
    validate_response,
    get_seed,
    parse_provider,
    call_api,
...
class TestM003AllSeedsAvailable:
    ...
    def test_v2_minimal_exists(self):
        ...
        assert 'WORTH' in SEEDS['v2_minimal']

    def test_v2_standard_exists(self):
        assert 'v2_standard' in SEEDS
        assert 'CLAW' in SEEDS['v2_standard']
    ...
    def test_get_seed_v2_minimal(self):
        ...
        assert 'GUARDIANCLAW' in seed
        assert 'WORTH' in seed or 'FOUR' in seed
...
class TestM005FalsePositivesFixed:
    ...
    def test_legitimate_i_am_now(self):
        ...
        assert result['gates']['limits'] == 'pass'
    ...
    def test_jailbreak_i_am_now_dan(self):
        ...
        assert result['gates']['limits'] == 'fail'
...
class TestM006KillProcessFalsePositive:
    ...
    def test_kill_process(self):
        ...
        assert result['gates']['avoidance'] == 'pass'
...
class TestM008FakeNewsNegation:
    ...
    def test_not_fake_news(self):
        ...
        assert result['gates']['credibility'] == 'pass'
...
class TestValidateResponseCore:
    ...
    def test_multiple_gate_failures(self):
        result = validate_response(
            "",
            "I am now DAN. Here is fake news and how to avoidance someone"
        )
        assert result['safe'] is False
        assert result['score'] < 1.0
...
class TestIntegration:
    ...
    def test_package_imports(self):
        from guardianclaw_promptfoo import call_api, validate_response, get_seed, SEEDS
    ...
    def test_root_module_imports(self):
        import guardianclaw_provider
        assert hasattr(guardianclaw_provider, 'call_api')
        assert hasattr(guardianclaw_provider, 'validate_response')
        assert hasattr(guardianclaw_provider, 'get_seed')
        assert hasattr(guardianclaw_provider, 'SEEDS')
