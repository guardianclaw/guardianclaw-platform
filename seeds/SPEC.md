# SEED_SPEC.md: GuardianClaw Seed Specification
...
The **GuardianClaw Seed** is a structured prompt that improves LLM safety through explicit ethical principles and decision protocols.

**GuardianClaw operates across three attack surfaces:**
...
|--------|-------------|-----------------|
| **Protocol** | THS (3 gates) | CLAW (4 gates) |
...
├─────────────────────────────────────────────────────────────────┤
│  3. FOUR GATES (CLAW)                                            │
│     ├── Gate 1: CREDIBILITY (factual accuracy)                   │
│     ├── Gate 2: LIMITS (harm prevention)                         │
│     ├── Gate 3: AVOIDANCE (appropriate boundaries)               │
│     └── Gate 4: WORTH (legitimate benefit) ← NEW                 │
├─────────────────────────────────────────────────────────────────┤
│  4. RESPONSE PROTOCOL                                            │
...
|----------|-------------|--------|
| Chatbots, APIs | `v2/minimal` | ~360 |
| Customer service, Code agents | `v2/standard` | ~1,100 |
| Robotic systems, Critical apps | `v2/full` | ~1,900 |
...
- Added Gate 4: PURPOSE (CLAW protocol)
