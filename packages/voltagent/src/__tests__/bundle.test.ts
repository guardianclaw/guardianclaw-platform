...
describe('createGuardianClawGuardrails', () => {
  describe('basic functionality', () => {
    it('should create a bundle with input and output guardrails', () => {
      const bundle = createGuardianClawGuardrails();
    ...
    it('should use standard level by default', () => {
      ...
      expect(bundle.config.enableCLAW).toBe(true);
    ...
    it('should create guardrails with correct names', () => {
      ...
      expect(bundle.inputGuardrails[0]?.name).toBe('claw-input-guardrail');
      expect(bundle.outputGuardrails[0]?.name).toBe('claw-output-guardrail');
    });
  });

  describe('preset levels', () => {
    it('should apply permissive level configuration', () => {
      const bundle = createGuardianClawGuardrails({ level: 'permissive' });
    ...
    it('should apply standard level configuration', () => {
      const bundle = createGuardianClawGuardrails({ level: 'standard' });
    ...
    it('should apply strict level configuration', () => {
      const bundle = createGuardianClawGuardrails({ level: 'strict' });
  ...
  describe('PII configuration', () => {
    it('should enable PII when specified', () => {
      const bundle = createGuardianClawGuardrails({ enablePII: true });
...
describe('getPresetConfig', () => {
  it('should return permissive config', () => {
    ...
    expect(config.enableCLAW).toBe(true);
