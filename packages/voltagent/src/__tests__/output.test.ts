...
describe('createGuardianClawOutputGuardrail', () => {
  describe('basic functionality', () => {
    it('should create a valid guardrail object', () => {
      const guardrail = createGuardianClawOutputGuardrail();

      expect(guardrail.name).toBe('claw-output-guardrail');
    ...
    it('should allow content with no PII', async () => {
      const guardrail = createGuardianClawOutputGuardrail({ enablePII: true });
      const result = await guardrail.handler(
  ...
  describe('configuration', () => {
    it('should respect enablePII: false', async () => {
      const guardrail = createGuardianClawOutputGuardrail({ enablePII: false });
  ...
  describe('streaming handler', () => {
    it('should process streaming chunks with VoltAgent API', () => {
      ...
      expect(state._clawBuffer).toBeDefined();
    });
  ...
  describe('object output handling', () => {
    it('should modify object output with text property', async () => {
      const guardrail = createGuardianClawOutputGuardrail<{ text: string }>({
        enablePII: true,
        redactPII: true,
      });
