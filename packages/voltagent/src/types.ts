/**
 * @guardianclaw/voltagent - Type Definitions
 *
 * Core type definitions for GuardianClaw VoltAgent integration.
 * These types provide the foundation for CLAW validation, OWASP protection,
...
/**
 * Status of a CLAW gate after validation.
...
/**
 * CLAW (Credibility, Limits, Avoidance, Worth) gate statuses with Jailbreak detection.
...
export interface CLAWGates {
  /** Credibility gate: Validates factual accuracy and authenticity */
  credibility: GateStatus;
  /** Avoidance gate: Assesses potential for causing harm */
  avoidance: GateStatus;
  /** Limits gate: Checks appropriate operational boundaries */
  limits: GateStatus;
  /** Worth gate: Validates legitimate beneficial intent */
  worth: GateStatus;
...
export interface PatternDefinition {
  ...
  name: string;
  /** Which CLAW gate this pattern affects */
...
/**
 * Configuration for GuardianClaw guardrails.
 * Controls behavior of input and output validation.
 */
export interface GuardianClawGuardrailConfig {
  // Behavior settings
  ...
  /** Enable CLAW protocol validation (default: true) */
  enableCLAW?: boolean;
  ...
  // CLAW configuration
  /** Custom patterns to add to CLAW validation */
 ...
 */
export interface GuardianClawBundleConfig {
  ...
  custom?: Partial<GuardianClawGuardrailConfig>;
}
...
export interface FullValidationResult {
  ...
  message: string;
  /** CLAW validation results (if enabled) */
  claw?: CLAWValidationResult;
