/**
 * @guardianclaw/voltagent - OWASP Validator
 *
 ...
 * Expanded to match core CLAW jailbreak detection patterns.
 *
 * Note: For comprehensive jailbreak detection, use the CLAW validator
 * which imports from @guardianclaw/core with 100+ patterns.
 */
