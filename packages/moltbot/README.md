# @guardianclaw/moltbot

[![npm version](https://img.shields.io/npm/v/@guardianclaw/moltbot.svg)](https://www.npmjs.com/package/@guardianclaw/moltbot)
...
**Resources**
- [Integration Guide](https://github.com/guardian-claw/guardianclaw/blob/main/docs/integrations/moltbot.md)
...
- [Examples](https://github.com/guardian-claw/guardianclaw/tree/main/packages/moltbot/examples)
...
```typescript
import { AlertManager } from '@guardianclaw/moltbot';
...
```typescript
import { validateOutput, validateTool, analyzeInput } from '@guardianclaw/moltbot';
import { getLevelConfig } from '@guardianclaw/moltbot';
