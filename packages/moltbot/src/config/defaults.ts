/**
 * @guardianclaw/moltbot - Default Configuration
 *
 ...
 */
export const DEFAULT_CONFIG: GuardianClawMoltbotConfig = {
  level: 'watch',
  alerts: {
    enabled: true,
  },
 ...
 */
export function getDefaultConfig(): GuardianClawMoltbotConfig {
  return {
