/**
 * @guardianclaw/moltbot - Configuration Module
 *
 * This module provides level presets, configuration parsing,
 * and default values for GuardianClaw Moltbot integration.
 *
 * @example
 * ```typescript
 * import { LEVELS, parseConfig, getLevelConfig } from '@guardianclaw/moltbot/config';
 *
