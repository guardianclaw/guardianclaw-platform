/**
 * @guardianclaw/moltbot - Hooks Module
 *
 ...
 * @example
 * ```typescript
 * import { createGuardianClawHooks } from '@guardianclaw/moltbot/hooks';
 *
...
import type { GuardianClawMoltbotConfig, LevelConfig } from '../types';
...
/**
 * Complete set of GuardianClaw hooks for Moltbot.
 *
...
interface HooksState {
  ...
  readonly config: GuardianClawMoltbotConfig;
...
/**
 * Create GuardianClaw hooks for Moltbot integration.
 *
...
export function createGuardianClawHooks(
  userConfig: Partial<GuardianClawMoltbotConfig>
): GuardianClawHooks {
