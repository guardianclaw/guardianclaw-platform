/**
 * @guardianclaw/moltbot - Type Definitions
 *
 * Core type definitions for GuardianClaw Moltbot integration.
 ...
 */
export interface GuardianClawMoltbotConfig {
 ...
 * Package name.
 */
export const PACKAGE_NAME = '@guardianclaw/moltbot';
