/**
 * @guardianclaw/openclaw - Type Definitions
 *
 * Core type definitions for GuardianClaw OpenClaw integration.
 * These types provide the foundation for protection levels,
 * validation, and OpenClaw hook integration.
 */
 ...
 */
export interface GuardianClawOpenClawConfig {
...
export interface DetectedIssue {
  ...
  /** Severity level */
  severity: RiskLevel;
  /** Which CLAW gate this affects */
  gate?: 'credibility' | 'avoidance' | 'limits' | 'worth' | 'jailbreak';
}
...
export interface AllowOnceState {
  ...
  active: boolean;
  /** Limits of the allow-once */
  limits?: 'output' | 'tool' | 'any';
...
export interface PauseState {
  /** Whether GuardianClaw is paused */
  paused: boolean;
...
/**
 * Action types for GuardianClaw messages.
 */
export type GuardianClawAction =
  | 'blocked'
  | 'modified'
  | 'alerted'
  | 'info'
 ...
 */
export interface GuardianClawMessage {
  /** Action that triggered this message */
  action: GuardianClawAction;
  /** Brief title */
  title: string;
 ...
 * Package name.
 */
export const PACKAGE_NAME = '@guardianclaw/openclaw';

/**
 * Supported OpenClaw version range.
 */
export const OPENCLAW_VERSION_RANGE = '>=2026.0.0';
