/**
 * @guardianclaw/openclaw - Default Configuration
 *
 ...
 */
export const DEFAULT_CONFIG: GuardianClawOpenClawConfig = {
  level: 'watch',
  alerts: {
    enabled: true,
  },
 ...
 */
export function getDefaultConfig(): GuardianClawOpenClawConfig {
  return {
