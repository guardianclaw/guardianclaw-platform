/**
 * @guardianclaw/openclaw - Configuration Module
 *
 * This module provides level presets, configuration parsing,
 * and default values for GuardianClaw OpenClaw integration.
 *
 * @example
 * ```typescript
 * import { LEVELS, parseConfig, getLevelConfig } from '@guardianclaw/openclaw/config';
 *
