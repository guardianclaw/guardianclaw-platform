 ...
 * Hooks Index Tests
 *
 * Tests for the createGuardianClawHooks factory and hook integration.
 */

import { describe, it, expect, beforeEach, vi, afterEach } from 'vitest';
import {
  createGuardianClawHooks,
  type GuardianClawHooks,
} from '../hooks';
import type {
...
// =============================================================================
// createGuardianClawHooks Tests
// =============================================================================

describe('createGuardianClawHooks', () => {
  describe('Factory Creation', () => {
    ...
    it('should accept all protection levels', () => {
      ...
      for (const level of levels) {
        const hooks = createGuardianClawHooks({ level });
        expect(hooks).toBeDefined();
      }
    });
  ...
  describe('messageReceived Hook', () => {
    let hooks: GuardianClawHooks;

    beforeEach(() => {
      hooks = createGuardianClawHooks({ level: 'guard' });
    });
  ...
  describe('beforeAgentStart Hook', () => {
    ...
    it('should return seed for guard level', () => {
      ...
      expect(result).toBeDefined();
      expect(result?.additionalContext).toContain('GuardianClaw');
    });
  ...
  describe('messageSending Hook', () => {
    ...
    it('should not block in off mode', async () => {
      const offHooks = createGuardianClawHooks({ level: 'off' });
      const event = createMessageSendingEvent(
        'session-1',
  ...
  describe('beforeToolCall Hook', () => {
    ...
    it('should respect trusted tools', async () => {
      const customHooks = createGuardianClawHooks({
        level: 'guard',
