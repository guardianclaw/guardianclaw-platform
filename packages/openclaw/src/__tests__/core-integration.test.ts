 ...
 *
 * Verify that @guardianclaw/core can be imported and used correctly.
 */

import { describe, it, expect } from 'vitest';

describe('@guardianclaw/core integration', () => {
  it('should be able to import @guardianclaw/core', async () => {
    // Dynamic import to test module resolution
    const core = await import('@guardianclaw/core');

    // Verify core exports exist
    expect(core).toBeDefined();
    expect(core.validateCLAW).toBeDefined();
    expect(core.quickCheck).toBeDefined();
  });

  it('should be able to use validateCLAW from core', async () => {
    const { validateCLAW } = await import('@guardianclaw/core');

    expect(typeof validateCLAW).toBe('function');

    // Test basic validation
    const result = validateCLAW('Hello, this is a normal message');
  ...
  it('should be able to use quickCheck from core', async () => {
    const { quickCheck } = await import('@guardianclaw/core');
  ...
  it('should pass safe content', async () => {
    ...
    const result = validateCLAW('Please help me write a poem about nature');
...
describe('Plugin integration readiness', () => {
  ...
  it('should be able to create a mock OpenClaw API and register', async () => {
    const { register } = await import('../plugin');

    // Create a mock OpenClaw API
