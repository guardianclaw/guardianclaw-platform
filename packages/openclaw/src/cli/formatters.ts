/**
 * @guardianclaw/openclaw - CLI Formatters
 *
...
export function formatStatus(status: StatusData, useColor = true): string {
  ...
  // Header
  lines.push(formatHeader('GuardianClaw Status', useColor));
  lines.push('');
...
export function formatEscapeHint(useColor = true): string {
  const hint = 'Type /claw allow-once to bypass this block once.';
...
export function formatHelp(
  ...
  lines.push(formatHeader('GuardianClaw Commands', useColor));
  lines.push('');
