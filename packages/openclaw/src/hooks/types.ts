/**
 * @guardianclaw/openclaw - Hook Type Definitions
 *
 * This module defines the type contracts for GuardianClaw hooks.
 *
 * Architecture:
 * - Event types: Input received from OpenClaw (or caller)
 * - Result types: Output returned by GuardianClaw handlers
 * - Session types: Per-session state tracking
 *
 * Design Principles:
 * - Event types are OpenClaw-compatible (minimal, what OpenClaw provides)
 * - Result types are GuardianClaw-rich (detailed info for logging/metrics)
...
// =============================================================================
// These types represent what OpenClaw (or any caller) provides to hooks.
...
// =============================================================================
// These types represent what GuardianClaw returns after processing.
...
// =============================================================================
// These types match what OpenClaw expects from hooks.
// They are simpler than our internal result types.

/**
 * What OpenClaw expects from before_agent_start hook.
 */
export interface OpenClawAgentStartResult {
...
/**
 * What OpenClaw expects from message_sending hook.
 */
...
/**
 * What OpenClaw expects from before_tool_call hook.
 */
