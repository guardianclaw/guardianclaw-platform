 ...
 *
 * AI safety guardrails for OpenClaw applications.
 *
 * This package provides OpenClaw-compatible hooks that implement:
 ...
 * ```
 *
 * @see https://github.com/guardianclaw/guardianclaw-platform/tree/main/packages/openclaw
...
export { createGuardianClawHooks } from './hooks';
...
import { VERSION, PACKAGE_NAME, OPENCLAW_VERSION_RANGE } from './types';

export { VERSION, PACKAGE_NAME, OPENCLAW_VERSION_RANGE };
