/**
 * @guardianclaw/openclaw - Pattern Definitions
 *
 * This module re-exports and extends patterns from @guardianclaw/core.
 * It also provides access to the extensible pattern registry for OpenClaw-specific patterns.
 *
 * Architecture:
 * - Core patterns (jailbreak, avoidance, etc.) come from @guardianclaw/core
