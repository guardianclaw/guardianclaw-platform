/**
 * @guardianclaw/openclaw - Escape Hatches Module
 *
 * Provides mechanisms for users to override GuardianClaw protection
...
export class EscapeManager {
  ...
  grantAllowOnce(
    sessionId: string,
    options?: { limits?: AllowOnceScope; expirationMs?: number }
  ) {
  ...
  getState(sessionId: string): EscapeState {
    ...
    return {
      ...
      allowOnceScope: allowOnceState.limits,
