/**
 * @guardianclaw/openclaw - Pause Escape Hatch
 *
 * Provides a mechanism to temporarily pause GuardianClaw protection.
...
/**
 * Options for pausing GuardianClaw.
 */
...
/**
 * Manages pause state for GuardianClaw protection.
 *
...
export class PauseManager {
  ...
  /**
   * Pause GuardianClaw for a session.
   *
  ...
  /**
   * Pause GuardianClaw globally for all sessions.
   *
   * @param options - Pause options
   * @returns Pause result
   */
  ...
  /**
   * Resume GuardianClaw for a session.
   *
  ...
  /**
   * Check if GuardianClaw is paused for a session.
   *
