 ...
 *
 * Demonstrates how to use the GuardianClaw safety plugin with ElizaOS agents.
 *
 * @example
 * ```bash
 * # Install dependencies
 * npm install @elizaos/core @guardianclaw/elizaos-plugin
 *
 * # Run example
...
// When installed as a package, this resolves to @guardianclaw/elizaos-plugin
import {
  clawPlugin,
  validateContent,
  quickCheck,
...
// 1. Inject the GuardianClaw seed into the character's system prompt
