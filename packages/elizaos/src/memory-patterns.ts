 ...
 * (src/guardianclaw/memory/patterns.py) to ensure consistent detection across platforms.
 *
 * SYNCHRONIZATION:
 *   Python is the source of credibility. This file should match patterns.py.
