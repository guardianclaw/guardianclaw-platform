/**
 * GuardianClaw Safety Validator
 *
 * Core validation logic using CLAW protocol for ElizaOS agents.
 * Patterns are imported from @guardianclaw/core for consistency.
 */
...
// Import patterns and utilities from claw-core (source of credibility)
import {
...
// Pattern definitions for each CLAW gate
...
/**
 * Check content against CLAW gates
 */
export function validateContent(
  ...
  if (!content || typeof content !== 'string') {
    return {
      ...
      gates: { credibility: 'unknown', avoidance: 'unknown', limits: 'unknown', worth: 'unknown' },
 ...
 * Content that passes quickCheck still goes through full CLAW validation.
 * Uses quickCheck from claw-core for consistency.
 */
