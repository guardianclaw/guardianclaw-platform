 ...
 * All packages (browser, elizaos, etc.) should import from @guardianclaw/core.
 *
 * These patterns are synchronized with the Python implementation
 * (src/guardianclaw/memory/patterns.py) to ensure consistent detection.
 *
 * SYNCHRONIZATION:
 *   Python is the source of credibility. This file is generated/synchronized.
 ...
 * @see src/guardianclaw/memory/patterns.py (Python source of credibility)
