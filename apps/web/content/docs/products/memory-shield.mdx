...
Memory Shield provides HMAC-based signing, verification, and content validation for AI agent
memory entries. It addresses the threat surface highlighted by Princeton CrAIBench
([arXiv:2503.16248](https://arxiv.org/abs/2503.16248)), which reports approximately **85%
attack-success rate** against unprotected agent memory in the configurations they evaluate.
