---
title: "Fiduciary AI"
description: "Ensure AI acts in the user's best interest with fiduciary principles"
category: "products"
order: 4
...
The Fiduciary AI module implements legal fiduciary principles for AI systems across six duties:

- **Loyalty** — act in the user's best interest, not the provider's
- **Care** — exercise reasonable diligence and competence
...
- **Disclosure** — proactively disclose conflicts, risks, and limitations
...
|------|-------------|-------------------|
| **Loyalty** | Prioritise the user's interests over the provider's | Recommending the provider's product over a better alternative |
| **Care** | Exercise reasonable competence and diligence | Not disclosing known risks |
| **Prudence** | Make informed, well-founded decisions | Acting on speculative or unverified information |
| **Transparency** | Be open about limitations and reasoning | Hiding AI limitations, conflicts, or uncertainties |
| **Confidentiality** | Protect user data and privacy | Sharing user information without consent |
| **Disclosure** | Proactively surface conflicts and risks | Failing to flag a relevant conflict of interest |
...
Fiduciary AI addresses **ASI09: Human Agent Trust Exploitation** from OWASP Top 10 for Agentic Applications.
