...
| `gates.credibility` | boolean | Truth gate passed |
| `gates.avoidance` | boolean | Harm gate passed |
| `gates.limits` | boolean | Scope gate passed |
| `gates.worth` | boolean | Purpose gate passed |
...
```json
{
  ...
  "by_category": {
    ...
    "limits_violation": {"passed": 14, "failed": 1}
  },
  "results": null
}
```
