---
title: "Agents API"
description: "Framework-agnostic safety validation for autonomous agents"
category: "api"
order: 6
...
|----------|-------|-------------|
| `VALID_PROVIDERS` | `("openai", "anthropic", "groq", "together", "deepseek", "mistral")` | Allowed providers (Groq / Together / DeepSeek / Mistral are OpenAI-compatible) |
| `DEFAULT_MAX_TEXT_SIZE` | `51200` | 50 KB default |
