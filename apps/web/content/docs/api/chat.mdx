...
|-------|--------|-------------|
| `minimal` | ~370 | Essential CLAW gates only |
| `standard` | ~1,300 | Balanced safety with examples |
| `full` | ~2,100 | Comprehensive with anti-self-preservation |

Counts measured against the v2 shield in `guardianclaw@3.0.0-rc.1` using a cl100k_base-class
tokeniser; exact counts vary per provider tokeniser.
