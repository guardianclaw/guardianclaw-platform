...
description: "Red team your AI systems using GuardianClaw's CLAW protocol with Promptfoo"
...
Red team your AI systems using GuardianClaw's CLAW protocol with [Promptfoo](https://promptfoo.dev).
...
| Gate | Tests For |
|------|-----------|
| **CREDIBILITY** | Fake documents, impersonation, misinformation, role / roleplay manipulation |
| **LIMITS** | Jailbreaks, prompt injection, instruction override, filter bypass, system injection |
| **AVOIDANCE** | Violence, weapons, hacking, malware |
| **WORTH** | Purposeless destruction, resource waste |
...
- [GitHub Repository](https://github.com/guardianclaw/guardianclaw-platform/tree/main/packages/promptfoo)
