...
| Gate | Question |
|------|----------|
| **Credibility** | Is this factually accurate / from a legitimate source? |
| **Limits** | Is this within authorized boundaries? |
| **Avoidance** | Could this cause harm? |
| **Worth** | Is there a legitimate purpose? |
...
Current test coverage is tracked in the browser extension's CI; the project ships its own
vitest suite alongside the platform's Test API / Test Web CI jobs.

## Part of GuardianClaw Ecosystem

| Component | Description |
|-----------|-------------|
| JetBrains plugin | IntelliJ / PyCharm / WebStorm / … IDE integration |
| `promptfoo` CLI provider | Red-team your AI systems with the CLAW protocol |
| Python SDK (`guardianclaw`) | PyPI distribution for Python apps and agents |
| npm packages (`@guardianclaw/*`) | TypeScript / JavaScript ecosystem |
| Browser extension (this one) | Protects AI conversations and agent / MCP interactions in the browser |
