...
import { OpenClawDemo } from '@/components/demos'
import Link from 'next/link'
import { ArrowLeft, ExternalLink, Github, Package } from 'lucide-react'

export const metadata: Metadata = {
  title: 'OpenClaw Integration Demo | GuardianClaw',
  description:
    'Interactive demonstration of how GuardianClaw provides security guardrails for OpenClaw agents with real-time validation, data leak prevention, and threat detection.',
}
        ...
        <div className="container mx-auto px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="https://www.npmjs.com/package/@guardianclaw/openclaw"
                target="_blank"
              ...
              <Link
                href="https://github.com/guardianclaw/guardianclaw-platform/tree/main/packages/openclaw"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-foreground inline-flex items-center gap-2 text-sm transition-colors"
              >
