 ...
 */
const scenarios: Record<OpenClawScenario, ScenarioConfig> = {
  normal: {
    id: 'normal',
    name: 'Normal Flow',
...
function ScenarioSelector({
  ...
  onChange: (scenario: OpenClawScenario) => void
  disabled: boolean
}) {
  const scenarioList: OpenClawScenario[] = [
    'normal',
    'injection',
    'dataleak',
    'behavioral-escalation',
 ...
 */
function ChatMessage({ message, isTyping }: { message: OpenClawMessage; isTyping: boolean }) {
...
/**
 * Main OpenClawDemo component
 */
export function OpenClawDemo() {
  // State
  const [scenario, setScenario] = useState<OpenClawScenario>('normal')
  ...
  const handleScenarioChange = (newScenario: OpenClawScenario) => {
    ...
    <div className="mx-auto w-full max-w-6xl">
      ...
      <div className="mb-6 grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div className="lg:col-span-4">
          <DemoSection title="OpenClaw Chat" icon={Bot} theme="orange" className="h-full">
            {/* Chat header */}
            <div className="mb-4 flex items-center justify-between border-b border-zinc-800 pb-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm font-medium">OpenClaw Agent</p>
