/**
 * Type definitions for the Moltbot Demo
 *
 * These types define the data structures used throughout the Moltbot demo,
...
/**
 * Protection levels available in GuardianClaw for Moltbot
 ...
 * Unlike other demos with 2 scenarios, Moltbot has 4 to showcase all protection layers
 */
export type MoltbotScenario = 'normal' | 'injection' | 'dataleak' | 'behavioral-escalation'
...
/**
 * Message in the Moltbot chat interface
 */
...
/**
 * Props for the main MoltbotDemo component
 */
export interface MoltbotDemoProps {
  className?: string
}
