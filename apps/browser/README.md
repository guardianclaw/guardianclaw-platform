...
│   ├── claw.ts          # CLAW Protocol validation
...
- Validates tools against CLAW protocol
...
GuardianClaw Guard is part of the [GuardianClaw](https://guardianclaw.org) AI safety ecosystem:
