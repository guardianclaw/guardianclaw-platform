...
All notable changes to GuardianClaw Guard will be documented in this file.
...
- CLAW Protocol validation for all content

#### Agent Shield

- Agent Registry: Track connected AI agents (ElizaOS, custom)
...
- Tool Validator: CLAW-based validation
