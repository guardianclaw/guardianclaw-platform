/**
 * GuardianClaw Guard - Internationalization (i18n)
...
const translations: Record<Language, Translations> = {
  en: {
    ...
    overview: 'Overview',
    clawGates: 'CLAW Gates',
    parameters: 'Parameters',
    description: 'Description',
    estimatedValue: 'Estimated Value',
    clawOverall: 'CLAW Overall',
    passed: 'Passed',
    failed: 'Failed',
    summary: 'Summary',
    score: 'Score',
  ...
  es: {
    ...
    overview: 'Resumen',
    clawGates: 'Puertas CLAW',
    parameters: 'Parámetros',
    description: 'Descripción',
    estimatedValue: 'Valor Estimado',
    clawOverall: 'CLAW General',
    passed: 'Aprobado',
    failed: 'Fallido',
    summary: 'Resumen',
    score: 'Puntuación',
  ...
  pt: {
    ...
    clawGates: 'Portões CLAW',
    parameters: 'Parâmetros',
    description: 'Descrição',
    estimatedValue: 'Valor Estimado',
    clawOverall: 'CLAW Geral',
    passed: 'Aprovado',
    failed: 'Falhou',
    summary: 'Resumo',
    score: 'Pontuação',
