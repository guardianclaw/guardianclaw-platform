...
import type { ActionHistoryEntry, ApprovalDecision, AgentAction, MCPToolCall, CLAWResult } from '../../../types';
...
// Helper to create mock CLAW result
function createMockCLAWResult(): CLAWResult {
  return {
    credibility: { passed: true, score: 1, issues: [] },
    avoidance: { passed: true, score: 1, issues: [] },
    limits: { passed: true, score: 1, issues: [] },
    worth: { passed: true, score: 1, issues: [] },
    overall: true,
...
function createMockAgentAction(overrides: Partial<AgentAction> = {}): AgentAction {
  return {
    ...
    params: { amount: 100 },
    clawResult: createMockCLAWResult(),
    riskLevel: 'medium',
    timestamp: Date.now(),
    status: 'pending',
    ...overrides,
