...
const App: React.FC = () => {
  ...
  const loadData = async () => {
    try {
      ...
      console.warn('[GuardianClaw Guard] Could not connect to background:', err);
    ...
    <div style={styles.container}>
      ...
      <header style={styles.header}>
        <div style={styles.headerContent}>
          ...
          <span style={styles.title}>GuardianClaw Guard</span>
        </div>
        <button
      ...
      <footer style={styles.footer}>
        <a href="https://guardianclaw.org" target="_blank" rel="noopener noreferrer" style={styles.link}>
          guardianclaw.org
        </a>
