 ...
 *
 * v2.0: Refactored to use synchronized patterns from @guardianclaw/core,
...
export function detectInjection(
  ...
  for (const pattern of COMPILED_MEMORY_INJECTION_PATTERNS) {
...
export function getScannerStatistics(): {
  ...
  return {
    ...
    patternCount: COMPILED_MEMORY_INJECTION_PATTERNS.length,
