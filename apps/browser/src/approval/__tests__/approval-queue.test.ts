...
function createMockCLAWResult() {
  return {
    credibility: { passed: true, score: 100, issues: [] },
    avoidance: { passed: true, score: 100, issues: [] },
    limits: { passed: true, score: 100, issues: [] },
    worth: { passed: true, score: 100, issues: [] },
    overall: true,
