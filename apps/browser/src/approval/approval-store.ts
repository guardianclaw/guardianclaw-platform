...
/** Database name */
const DB_NAME = 'claw-guard';

/** Current database version */
const DB_VERSION = 1;

/** IndexedDB schema definition */
interface GuardianClawDBSchema extends DBSchema {
...
let dbInstance: IDBPDatabase<GuardianClawDBSchema> | null = null;
 ...
 */
export async function getDatabase(): Promise<IDBPDatabase<GuardianClawDBSchema>> {
  if (dbInstance) {
    return dbInstance;
  }

  dbInstance = await openDB<GuardianClawDBSchema>(DB_NAME, DB_VERSION, {
